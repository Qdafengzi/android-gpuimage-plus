...
public class CameraDemoBack extends AppCompatActivity {
    ...
    public static CameraDemoBack mCurrentInstance = null;

    public static CameraDemoBack getInstance() {
    ...
    class RecordListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (!BuildConfig.CGE_USE_VIDEO_MODULE) {
                MsgUtil.toastMsg(CameraDemoBack.this, "gradle.ext.disableVideoModule is defined to true, video module disabled!!");
                return;
            }
